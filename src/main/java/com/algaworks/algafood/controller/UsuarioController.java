...
import com.algaworks.algafood.api.convert.UsuarioInputDisassembler;
import com.algaworks.algafood.api.convert.UsuarioModelAssembler;
...
public class UsuarioController {
    ...
    public UsuarioModel atualizar(@PathVariable Long usuarioId,
            @RequestBody @Valid UsuarioModelInput usuarioModelInput) {
        Usuario usuarioAtual = cadastroUsuario.buscarOuFalhar(usuarioId);
        usuarioInputDisassembler.copyToDomainObject(usuarioModelInput, usuarioAtual);
